...
export const updateMessageSchema = z.object({
  ...
  respondedAt: z
    .union([
      z.string().datetime({ message: 'Format de date invalide (ISO 8601)' }),
      z.null()
    ])
    .optional()
    .nullable()
  ...
  respondedBy: z
    .union([
      z.string().uuid('ID utilisateur invalide'),
      z.null()
    ])
    .optional()
    .nullable(),
...
export const validateUpdateMessageField = (
  field: keyof UpdateMessageData,
  value: unknown
) => {

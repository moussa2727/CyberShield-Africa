...
export const metadata: Metadata = {
  ...
  description: 'Protégez votre entreprise contre les menaces numériques avec CyberShield Africa. Services de cybersécurité accessibles pour les PME africaines.',
